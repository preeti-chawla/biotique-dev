...
class Biotique_Banner_Block_Adminhtml_Catbanner_Grid extends Mage_Adminhtml_Block_Widget_Grid
{

	public function getRowUrl($item)
	{
		return $this->getUrl('*/catbanner/edit', array('catbanner_id' => $item->getId()));
	}

	protected function _prepareCollection()
	{
		$collection = Mage::getModel('banner/catbanner')->getCollection();
	...
	protected function _prepareColumns()
	{
		...
		$this->addColumn('subtitle', array(
			'type' => 'text',
			'index' => 'subtitle',
			'header' => $this->__('Slider Sub Title')
		));
	...
	{
		$this->setMassactionIdField('catbanner_id');
		$this->getMassactionBlock()->setformFieldName('catbanner_ids');
