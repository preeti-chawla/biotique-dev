...
class Mage_Adminhtml_Block_Review_Edit_Form extends Mage_Adminhtml_Block_Widget_Form
{
    protected function _prepareForm()
    {
		...
		$fieldset->addField('recommend', 'text', array( // New field 2
		'label' => Mage::helper('review')->__('Recommend this product'),
		'required' => true,
		'name' => 'recommend'
		));

        $fieldset->addField('loc', 'text', array( // New field 2
        'label' => Mage::helper('review')->__('Location'),
        'required' => true,
        'name' => 'loc'
        ));
        $fieldset->addField('age', 'text', array( // New field 2
        'label' => Mage::helper('review')->__('Age'),
        'required' => true,
        'name' => 'age'
        ));
