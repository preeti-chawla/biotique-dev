...
$(document).ready(function(){
   ...
   $(".hide3").click(function(){
	...
	$('ul.concernsList li a').click(function(e) 
...
/*
		...
		$("#storeListScroll1").mCustomScrollbar({
...
*/
    ...
    $('.tabs_P li:first').addClass('active');



      $('.tabs_P li a').click(function(){



      $('.tabs_P li').removeClass('active');
...
//	});
	...
	$(".cart-ctn").mouseleave(function(){
        ...
        //todo : this is a temp code added by Rahul  
        /*
        $j("#strip4").on("click", function(){
            $j(".bx-viewport").css("height", "auto");
            $j('.productSlider').bxSlider({auto: false, pager: false, controls: true});
        });*/
		...
		$('.testimonials .productSlider, .product-feature .productSlider, .specialofferColm .productSlider').bxSlider({
	...
	newCollectionSlider = $('.newCollectionSlider').bxSlider({
	...
	//pop 5
  	...
  	$('#e-forgot').click(function(){
  		...
  		$(this).parents().find('#forgotpassword').fadeIn();
  	...
  	$('.overlay').click(function(){
  		...
  		$(this).parents().find('#forgotpassword').fadeOut();
  	...
  	//$('.wrt-revw').click(function(){

  	$('.right-review > a').click(function(){



  		$(this).parents().find('#wrtreview').fadeIn();
  	...
  	$('.overlay').click(function(){
  		...
  		$(this).parents().find('#wrtreview').fadeOut();
    ...
    $('.stripContent').eq(4).show();



    $('.stripLinks li').eq(4).addClass('active');


        var isInit = false; // For top-offers
        ...
        if(!isInit && $(currentTab).find(".productSlider").length){
            $(currentTab).find(".productSlider li").css({"visiblity": "hidden"});
            $(currentTab).css({"max-height": "100px"});
        }
    	$(currentTab).show();

        
        
    	$('.footerStripBottom').animate({height: "show"}, 1000, function(){
            var $prodSlider = $(this).find(".productSlider");
            if(!isInit && $prodSlider.length){
                
                //$(this).find(".bx-viewport").css("height", "auto");
                //$prodSlider.hide();
                $prodSlider.bxSlider({auto: false, pager: false, controls: true});
                $(currentTab).find(".productSlider li").css({"visiblity": "visible"});
                //$(currentTab).css({"max-height": "auto"});
                //$prodSlider.show();
                isInit = true;
            }
        });
...
//$('.footerStripBottom').animate({height: "show"}, 1000);
	...
	// var appendVar3 = $('.shopContainer .detailSec .tabContainer').clone();



	// $('.m3-apnd-row').append(appendVar3);
	...
	$('.leftrow h4').click(function(){		
 		...
 		if($('i',$(this)).hasClass('fa-caret-down')){			
			...
			$(this).closest('.leftrow').find('ul').slideUp();
			...
			$(this).closest('.leftrow').find('ul').slideDown();
