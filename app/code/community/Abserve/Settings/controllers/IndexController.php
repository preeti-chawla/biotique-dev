...
class Abserve_Settings_IndexController extends Mage_Core_Controller_Front_Action{
    ...
    public function testmailAction(){
        echo $from_email = Mage::getStoreConfig('trans_email/ident_general/email'); 
        $processedTemplate = ' Your mail send successfully ' ;
        ...
        $mail = Mage::getModel('core/email')
            ...
            ->setSubject('Subject : Hotel Spa')
            ->setFromEmail('vinothkumarjeyaraman@gmail.com')
            ->setFromName('vinoth kumar J')
            ->setType('html');
        $mail->send();
    }
    ...
    public function HotelspaAction(){
        ...
        $mail = Mage::getModel('core/email')
            ...
            ->setBody($processedTemplate)
            ->setSubject('Subject : Hotel Spa')
            ->setFromEmail($_POST['email'])
            ->setFromName($_POST['person_name'])
            ->setType('html');
        $mail->send();
        ...
        Mage::getSingleton('core/session')->addSuccess('Thank you for contacting us. Someone from our team will get in touch with you soon.');
    ...
    public function CorporategiftAction(){
        ...
        $connection_insert->commit();
         Mage::getSingleton('core/session')->addSuccess('Thank you for submitting your enquiry. Someone from our team will get in touch with you soon.');
