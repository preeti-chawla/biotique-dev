 ...
 *
 */
class WP_OnePageCheckout_Block_Onepage_Paypal_Iframe extends Mage_Payment_Block_Form
{
    /**
    ...
    {
        parent::_construct();
        if (!Mage::helper('onepagecheckout')->hasPaypalHss()) return parent::_construct();
        ...
        if (in_array($paymentCode, $this->helper('paypal/hss')->getHssMethods())) {
            ...
            $templateFile = "webandpeople/onepagecheckout/onepage/paypal/{$templatePath}/iframe.phtml";
            if (file_exists(Mage::getDesign()->getTemplateFilename($templateFile))) {
                $this->setTemplate($templateFile);
            } else {
                $this->setTemplate('webandpeople/onepagecheckout/onepage/paypal/hss/iframe.phtml');
            }
        }
    }
    ...
    protected function _toHtml()
    {
        if ($this->_isAfterPaymentSave()) {
            $this->setTemplate('webandpeople/onepagecheckout/onepage/paypal/hss/js.phtml');
