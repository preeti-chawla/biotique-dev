...
class Mage_Review_ProductController extends Mage_Core_Controller_Front_Action
{
     ...
     */	 public function getAction(){		print_r('Hello');	}
    ...
    /*public function postAction(){
        ...
        $connection_insert->insert('review_detail', $__fields); 
        $connection_insert->commit();

        Mage::getSingleton('core/session')->addSuccess('Your review has been accepted for moderation.');
